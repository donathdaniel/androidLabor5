...
class MyViewModel : ViewModel() {
    ...
    fun startQuiz() {
        ...
        finalPoints = 0
        questionCounter = 0
//        val fileName = "com/example/quizapp/shared/questions.txt"
//        var text = ""
//        var answers: MutableList<Pair<String,Boolean>> = mutableListOf()
        ...
        var question5 = Question(mutableListOf(Pair("Shoe",false),Pair("Charcoal",true),Pair("Belt",true),Pair("All the above",false)), "What is black when you buy it, red when you use it, and gray when you throw it away?")
        ...
        var question8 = Question(mutableListOf(Pair("Son-in-law",true),Pair("Daughter-in-law",true),Pair("Grand mother",false),Pair("Grand Daughter",false)), "If Theresa's daughter is my daughter's mother, what am I to Theresa?")
